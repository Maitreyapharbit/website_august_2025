    ...
    <section ref={containerRef} className="section modern-section overflow-hidden">
      ...
      <div ref={timelineRef} className="flex items-center min-h-screen" style={{ width: `${timelineSteps.length * 100}vw` }}>
        ...
        {timelineSteps.map((step, index) => (
          <div
            key={step.id}
            className={`timeline-step-${index} flex-shrink-0 w-screen flex items-center justify-center px-8`}
          >
              ...
              <div className="glass-immersive p-12 rounded-3xl transform-gpu perspective-1000">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                  ...
                  <div className="glass-subtle p-8 rounded-2xl">
                    ...
                    <ul className={`step-details-${index} space-y-4`}>
      ...
      <div className="fixed bottom-8 right-8 glass-subtle p-4 rounded-2xl">
        <div className="flex items-center space-x-3 text-primary-white">
          ...
          <div className="flex space-x-1">
            <div className="w-2 h-2 bg-secondary-cyan rounded-full animate-bounce"></div>
            <div className="w-2 h-2 bg-secondary-cyan rounded-full animate-bounce" style={{ animationDelay: '0.1s' }}></div>
            <div className="w-2 h-2 bg-secondary-cyan rounded-full animate-bounce" style={{ animationDelay: '0.2s' }}></div>
          </div>
        </div>
      </div>
    </section>
