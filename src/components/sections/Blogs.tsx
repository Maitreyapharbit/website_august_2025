                    ...
                    <div className="modern-card p-6 card-hover magnetic float-slow">
                      ...
                      <div className="flex items-center justify-between pt-4 border-t border-secondary-teal">
                        <div className="flex items-center space-x-2">
                          <div className="w-8 h-8 bg-gradient-to-br from-primary-blue to-secondary-cyan rounded-full flex items-center justify-center animate-glow">
                      ...
                      {/* Read More Button */}
                      <button className="w-full mt-4 btn-primary py-2 rounded-lg font-semibold text-sm transition-all duration-300 hover:scale-105 magnetic">
                        Read More
                      </button>
                    </div>
                  </ScrollReveal>
