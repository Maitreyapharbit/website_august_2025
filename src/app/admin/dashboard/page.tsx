    ...
    <div className="px-4 py-6 sm:px-0">
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-gray-600">
          Manage your blog content and company information from here.
        </p>
      </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900">Pharbit</dd>
                </dl>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900">Administrator</dd>
                </dl>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            >
              ...
              <div className="mt-8">
                ...
                <p className="mt-2 text-sm text-gray-500">
                  Create, edit, and delete blog posts. Manage your content library.
                </p>
              </div>
            ...
            >
              ...
              <div className="mt-8">
                ...
                <p className="mt-2 text-sm text-gray-500">
                  Update company address, email, and other contact information.
                </p>
              </div>
              <span className="pointer-events-none absolute top-6 right-6 text-gray-300 group-hover:text-gray-400" aria-hidden="true">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
